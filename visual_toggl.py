...
# ### Reading files
# df = pd.read_csv("df_toggl.csv")
# df.columns = ['date', 'client_name', 'duration', 'ma']
# df_mean = pd.read_csv("df_mean_toggl.csv")
# df_mean = df_mean.set_index('client_name')
...
def offensive_ma():
    return [
        dbc.Col(html.Div([
        dbc.Row((html.H4(children = ['PhD'], style={"margin-left": "100px"}))), 
        dbc.Row(show_ma_phd()),
        dbc.Row(html.Br()),
        ...
        dbc.Col(html.Div([
        dbc.Row((html.H4(children = ['Financial'], style={"margin-left": "70px"}))), 
        dbc.Row(show_ma_fin()),
        dbc.Row(html.Br()),
    ],className = 'border border-dark')
    ),
...
def defensive_ma():
    return [dbc.Col(html.Div([
        dbc.Row((html.H4(children = ['Sleep'], style={"margin-left": "100px"}))), 
    ...
    dbc.Col(html.Div([
        dbc.Row((html.H4(children = ['No Value'], style={"margin-left": "70px"}))), 
        dbc.Row(show_ma_nov()),
        dbc.Row(html.Br()),
    ],className = 'border border-dark')
    ),
    ...
    dbc.Col(html.Div([
        dbc.Row((html.H4(children = ['Survival'], style={"margin-left": "70px"}))), 
